...
internal static class VoxBank
{
  ...
  public static Line ForMilestone(string kind, string detail)
  {
    ...
    return k switch
    {
      ...
      "soft-fail-warn" => new("vox.james",
        $"Near SoftFail — {Truncate(detail)}. Settle standing before the hold sticks."),
      "soft-fail-clear" => new("vox.james",
        $"Standing open — {Truncate(detail)}. Runway back."),
