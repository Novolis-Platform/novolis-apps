...
/// <summary>Speaks pasted text via Edge TTS (Ava), with on-disk cache, paragraph chunks, and MP3 export.</summary>
public sealed class SpeechService : IDisposable
{
    ...
    /// <summary>Returns whether cached audio exists for this exact text (Ava narrator).</summary>
