...
internal static class MarkdownStudioCss
{
    public const string Dark = """
        ...
        .markdown-body.studio {
          ...
          font-size: var(--ms-base-size, 15px);
          line-height: 1.65;
          color: #e8e8e8;
        ...
        .markdown-body.studio a { color: #6eb5ff; text-decoration: none; word-break: break-all; }
        ...
        .markdown-body.studio pre code { background: transparent; padding: 0; white-space: pre-wrap; }
    ...
    public const string GitHubLight = """
        ...
        .markdown-body.github-light h1,
        .markdown-body.github-light h2 {
        ...
        .markdown-body.github-light pre code { background: transparent; white-space: pre-wrap; }
        ...
        .markdown-body.github-light a { color: #0969da; word-break: break-all; }
